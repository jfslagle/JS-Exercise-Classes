...
class Lambdasian {
  ...
  speak() {
    return `My name is ${this.name} and I am from ${this.location}`;
  }
}
const Janna = new Lambdasian({ name: "Janna", age: 40, location: "Utah" });
console.log(Janna);
console.log(Janna.speak());
...
class ProjectManager extends Instructor {
  constructor(managerAttributes) {
    ...
    this.gradClassNames = managerAttributes.gradClassNames;
